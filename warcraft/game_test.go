...
func TestGameInfoPacket(t *testing.T) {
    ...
    expectedGameInfoData := []byte {
        ...
        0x50, 0x58, 0x33, 0x57, 0x16, 0x00, 0x00, 0x00, // client version
        0x0a, 0x00, 0x00, 0x00, // id
        0x98, 0x00, 0x00, 0x00, // entry key
        ...
        0x01, 0x02, 0x03, 0x04, // game type
        0x04, 0x00, 0x00, 0x00, // current players
        0x06, 0x00, 0x00, 0x00, // player slots
    ...
    expectedMapInfoData := []byte {
        ...
        0x68, 0x6f, 0x73, 0x74, 0x20, 0x6e, 0x61, 0x6d, 0x65, 0x00, // host name
    }
